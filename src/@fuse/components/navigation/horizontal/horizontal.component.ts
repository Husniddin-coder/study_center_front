...
@Component({
    ...
    standalone: true,
    imports: [NgFor, NgIf, PermissionCheckModule, FuseHorizontalNavigationBasicItemComponent, FuseHorizontalNavigationBranchItemComponent, FuseHorizontalNavigationSpacerItemComponent],
})
